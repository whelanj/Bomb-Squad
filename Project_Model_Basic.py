# -*- coding: utf-8 -*-
"""
Created on Wed Apr 29 16:03:27 2020
...
'''
The main inputs are timespan and reaction magnitude. If a new decay chain is to be examined, one would
...
plt.legend()
plt.grid()
plt.savefig('Model_Graph_Basic_{}s.png'.format(str(timespan)))
...
anim.save('Model_Gif_Basic_{}s.gif'.format(str(timespan)), dpi=72, writer='imagemagick')
